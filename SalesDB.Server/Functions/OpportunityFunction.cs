...
{
	public class OpportunityFunction 
	{
        // Função que verifica a região de um vendedor antes de realizar a inserção no banco de dados
        public static bool VerificaRegiao(Opportunity data)
        {
            char caracter = '\0';
            bool flag = false;

            // Códigos das cidades de uma região
            string[] codes = { "12", "27", "16", "13", "29", "23", "53", "32", "52", "21", "51", "50", "31", "15", "25", "41", "26", "22", "24", "43", "33", "11", "14", "42", "35", "28", "17" };

            for (int i = 0; i < codes.Length; i++)
            {

                // verifica se os codigos dos estados estão correpondente a regiao do vendedor
                caracter = codes[i].ToCharArray()[0];
